...
export const OrderProcessSteps: React.FC = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white rounded-3xl p-6 sm:p-12 shadow-2xl border border-slate-800">
        {/* En-tête */}
        ...
        <ol className="max-w-xl mx-auto divide-y divide-slate-800">
          {ORDER_STEPS.map((st, idx) => (
            <li key={idx} className="flex items-baseline gap-3 py-3.5">
              <span className="text-sm font-semibold text-slate-500 tabular-nums shrink-0">
